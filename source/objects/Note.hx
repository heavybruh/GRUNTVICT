...
class Note extends FlxSprite
{
	...
	public static var rand_color:Int = FlxG.random.int(0, 2);
	public static var fnm_arrow_color:Array<Array<FlxColor>> = [
		[0x3F32FE, 0xFFFFFFFF, 0x120F4C],
		[0xDBC437, 0xFFFFFFFF, 0x3E3A10],
		[0xFF3F2A, 0xFFFFFFFF, 0x611710]];
	...
	public function defaultRGB()
	{
		...
		if (ClientPrefs.data.fnm_arrows)
			arr = fnm_arrow_color[rand_color];
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inEditor:Bool = false, ?createdFrom:Dynamic = null)
	{
		...
		{
			rand_color = FlxG.random.int(0, 2);
			centerOffsets();
			centerOrigin();
		}
		x += offsetX;
	...
	function loadNoteAnims() {
		...
		var specific_note_scale:Float = 0.7;
		switch(PlayState.SONG.arrowSkin) {
			case 'noteSkins/gruntvict_note': specific_note_scale = 0.47;
		}
		setGraphicSize(Std.int(width * specific_note_scale));
