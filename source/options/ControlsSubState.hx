...
class ControlsSubState extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		controllerSpr = new FlxSprite(50, 40).loadGraphic(Paths.image('menus/options/controls_menu/controllertype'), true, 82, 60);
		...
		if(model == PS4)
		{
			switch(alpha.text)
			{
				case '[', ']': //Square and Triangle respectively
					letter.image = 'menus/options/controls_menu/alphabet_playstation';
					letter.updateHitbox();
