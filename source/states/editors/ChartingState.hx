...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Hud Angle Bop', "Value 1: Angle\nValue 2: RGB Strength (if shaders are enabled) --Heavy Bruh"]
	];
	...
	**/
	...
	override function create()
	{
		...
		quant = new AttachedSprite('menus/chart_editor/chart_quant','chart_quant');
		...
		zoomTxt = new FlxText(10, 690, 0, "Zoom: 1 / 1", 16);
	...
	{
		var speed_and_meth:Float = Conductor.bpm / 2;
		grid.velocity.set(speed_and_meth, speed_and_meth);
	...
	function setupNoteData(i:Array<Dynamic>, isNextSection:Bool):Note
	{
		...
		if(daSus != null) { //Common note
			...
			note.loadGraphic(Paths.image('menus/chart_editor/eventArrow'));
